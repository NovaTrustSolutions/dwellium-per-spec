...
export const WIDGET_REGISTRY: Record<string, WidgetRegistration> = {
    ...
    'content-search': {
        id: 'content-search',
        label: 'Search',
        description: 'Keyword search across brain dumps, syntheses, wiki pages, Foundry items, AI memory and file names.',
    ...
    // see researchLabImportGuard.test.ts + src/lib/researchLlm/guard.ts.
    'research-lab': {
        id: 'research-lab',
        label: 'Research Lab',
        ...
        tier: 'labs',
        icon: 'flask-conical',
        component: lazyWithReload(() => import('../components/ResearchLab/ResearchLab')),
        minWidth: 640,
        minHeight: 480,
        category: 'tools',
    },
