        ...
        <div className="s-glass-card">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                <h3 style={{ margin: 0, fontSize: 14, display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    {utilities.length > 0 && <span style={{ fontSize: 10, color: '#64748b', fontWeight: 400 }}>({utilities.length})</span>}
                </h3>
                            ...
                            <div key={u.id} style={{
                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    ...
                                    <div style={{ fontSize: 11, color: '#64748b', display: 'flex', gap: 12, marginTop: 2 }}>
                                        {u.accountNumber && <span>Acct: <strong style={{ color: '#94a3b8' }}>{u.accountNumber}</strong></span>}
