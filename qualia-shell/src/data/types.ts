...
export type Theme = 'dark' | 'light' | 'trust' | 'vibrant' | 'luxury' | 'healthcare' | 'creative' | 'dark-excellence' | 'terminal-bl4' | 'cosmos' | 'deep-dark' | 'simple-black' | 'cyberpunk' | 'synthwave' | 'solarized' | 'rose-pine' | 'mocha' | 'dracula' | 'obsidian' | 'tokyo-night' | 'gruvbox' | 'apple-dark' | 'nord' | 'latte' | 'corporate' | 'halocron';
