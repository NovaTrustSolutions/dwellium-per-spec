...
- **Last green CI run:** `24946665727` — `AppFolio Parity Gate` — HEAD at `b4b7c9a` — `https://github.com/NovaTrustSolutions/dwellium-per-spec/actions/runs/24946665727` (dispatched on main at sweep-commit time; PR-branch run `24946208978` was the green-source for the squash content).
