                            ...
                            <div style={{ display: 'flex', gap: '6px' }}>
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        background: 'transparent', color: '#f87171', fontSize: '10px', cursor: 'pointer'
                                    }}
                                >
                                    ↩️ Recover
                                </button>
