...
| 2.6 — Utilities: utility-vendor workitem seed (Duke Energy + Massey Pest on 128 BV, Georgia Power on Riverwood) | ✓ | `32006aa` *(pre-squash; sweep bumps to squash SHA post-merge)* | 2026-04-24 | `Docs/Phase2_Task_2_6_Completion_Report.md` (same 8-section template as Task 2.3 / 2.5 / 2.7 / 2.2 / 2.1 / 2.10 / 2.4; backs every ✓ cell with a section reference) |
| 2.8, 2.9 | pending | — | — | — |
