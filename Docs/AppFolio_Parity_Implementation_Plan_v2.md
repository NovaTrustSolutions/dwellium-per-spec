...
| 4.4 — Work Orders: 13 real WOs absorbed from `03_work_orders_page1.json` (19511-1 fire alarm / 19510-1 plug outlet / 19508-1 kitchen plugs / 19504-1 AC reservoir / 19503-1 stove vent / 19499-1 AC hot air / 19496-1 microwave light / 19441-1 sheetrock Assigned / 19438-1 Georgia Power Assigned / 19429-1 kitchen sink Assigned / 19424-1 yellow jackets / 19172-1 dishwasher Work Done / 19277-1 floor dipping Waiting) | R | — | — | — |
| 4.5 — Leases: 2 real pending-countersign leases from `06_leases.json` (Jamel D. Brown → Riverwood H12 + Vanessa V. Blunt → Riverwood D14; both generated 2026-03-31) | R | — | — | — |
...
Pending row: 6 (`4.2, 4.3, 4.4, 4.5, 4.6, 4.7` — 4.1 closed 2026-04-29 at squash SHA `5daa2d4`; FIXTURE-CLASS first PRE2 calibration anchored at +0 vitest delta / 0 kB module-graph drift on a +1-record / 1-test-invariant-relaxation scope; this is the canonical FIXTURE-CLASS shape and serves as the prediction-band anchor for 4.2–4.6). Phase-4 closes when 4.7 lands. Phase-4 column flips `R` → `✓` when the last row closes. Per Plan v2 §19 Appendix B (L578): `4.1, 4.2, 4.3, 4.4, 4.5, 4.6 (parallel) → 4.7 (last; feature flag flip)` — 4.2 / 4.3 / 4.4 / 4.5 / 4.6 are parallel-eligible (different fixture files per Appendix D); 4.7 is the last sequential closer that owns `strataApi.static.ts` + `.env.example`. Phase-4 deferred-items ledger entry at `Docs/Phase4_Task_4_1_Completion_Report.md §7` carries 6 items (pages 2-5 capture / R-3 STRIKE / metadata schema drift / metadata format consolidation / PropertiesModule top-level ErrorBoundary wrap / CDP probe selector helper). Recommended next task: **4.5** (smallest scope — 2 leases, isolated FK to `properties.json`, fastest path to a second FIXTURE-CLASS calibration point).
