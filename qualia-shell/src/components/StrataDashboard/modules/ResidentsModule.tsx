                    ...
                    <div role="presentation" style={{ width: 480, background: '#1e293b', borderRadius: 16, padding: 24, border: '1px solid color-mix(in srgb, var(--accent) 20%, transparent)', boxShadow: '0 24px 48px rgba(0,0,0,0.5)' }} onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleCreate}>
                            <div style={{ display: 'grid', gap: 12 }}>
                                <div><label htmlFor="residents-full-name" style={{ display: 'block', fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>Full Name *</label><input id="residents-full-name" name="name" required placeholder="John Doe" style={{ width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'var(--text-primary)', fontSize: 13, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' }} /></div>
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                                    <div><label htmlFor="residents-email" style={{ display: 'block', fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>Email</label><input id="residents-email" name="email" type="email" placeholder="tenant@email.com" style={{ width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'var(--text-primary)', fontSize: 13, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' }} /></div>
                                    <div><label htmlFor="residents-phone" style={{ display: 'block', fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>Phone</label><input id="residents-phone" name="phone" placeholder="555-000-0000" style={{ width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'var(--text-primary)', fontSize: 13, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' }} /></div>
                                </div>
                                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 12 }}>
                                    <div><label htmlFor="residents-property" style={{ display: 'block', fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>Property</label><select id="residents-property" name="propertyName" style={{ width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'var(--text-primary)', fontSize: 13, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' }}><option value="">Select property…</option>{uniqueProperties.map(p => <option key={p} value={p}>{p}</option>)}</select></div>
                                    <div><label htmlFor="residents-unit" style={{ display: 'block', fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>Unit</label><input id="residents-unit" name="unit" placeholder="101" style={{ width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'var(--text-primary)', fontSize: 13, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' }} /></div>
                                </div>
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
                                    <div><label htmlFor="residents-monthly-rent" style={{ display: 'block', fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>Monthly Rent</label><input id="residents-monthly-rent" name="rent" type="number" step="0.01" placeholder="1500" style={{ width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'var(--text-primary)', fontSize: 13, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' }} /></div>
                                    <div><label htmlFor="residents-lease-from" style={{ display: 'block', fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>Lease From</label><input id="residents-lease-from" name="leaseFrom" type="date" style={{ width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'var(--text-primary)', fontSize: 13, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' }} /></div>
                                    <div><label htmlFor="residents-lease-to" style={{ display: 'block', fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>Lease To</label><input id="residents-lease-to" name="leaseTo" type="date" style={{ width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'var(--text-primary)', fontSize: 13, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' }} /></div>
                                </div>
                                <div><label htmlFor="residents-tenant-type" style={{ display: 'block', fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>Tenant Type</label><select id="residents-tenant-type" name="tenantType" style={{ width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'var(--text-primary)', fontSize: 13, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' }}><option value="Residential">Residential</option><option value="Commercial">Commercial</option><option value="Section 8">Section 8</option></select></div>
                            </div>
                    ...
                    <div role="presentation" style={{ width: 560, maxWidth: '90vw', maxHeight: '85vh', background: '#1e293b', borderRadius: 16, padding: 0, border: '1px solid color-mix(in srgb, var(--accent) 20%, transparent)', boxShadow: '0 24px 48px rgba(0,0,0,0.5)', display: 'flex', flexDirection: 'column' }} onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleEditSave} style={{ flex: 1, overflowY: 'auto', padding: '16px 24px 24px' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 16 }}>
                                ...
                                <div><label htmlFor="residents-phone-2" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Phone</label><input id="residents-phone-2" className="s-input" value={editFormData.phone || ''} onChange={e => setEditFormData({...editFormData, phone: e.target.value})} /></div>
                            </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 10, marginBottom: 10 }}>
                                <div><label htmlFor="residents-property-2" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Property</label><input id="residents-property-2" className="s-input" value={editFormData.propertyName || ''} onChange={e => setEditFormData({...editFormData, propertyName: e.target.value})} /></div>
                                <div><label htmlFor="residents-unit-2" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Unit</label><input id="residents-unit-2" className="s-input" value={editFormData.unit || ''} onChange={e => setEditFormData({...editFormData, unit: e.target.value})} /></div>
                            </div>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10, marginBottom: 10 }}>
                                <div><label htmlFor="residents-monthly-rent-2" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Monthly Rent</label><input id="residents-monthly-rent-2" className="s-input" type="number" step="0.01" value={editFormData.rent || ''} onChange={e => setEditFormData({...editFormData, rent: e.target.value})} /></div>
                                <div><label htmlFor="residents-lease-from-2" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Lease From</label><input id="residents-lease-from-2" className="s-input" type="date" value={editFormData.leaseFrom || ''} onChange={e => setEditFormData({...editFormData, leaseFrom: e.target.value})} /></div>
                                <div><label htmlFor="residents-lease-to-2" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Lease To</label><input id="residents-lease-to-2" className="s-input" type="date" value={editFormData.leaseTo || ''} onChange={e => setEditFormData({...editFormData, leaseTo: e.target.value})} /></div>
                            </div>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 16 }}>
                                <div><label htmlFor="residents-tenant-type-2" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Tenant Type</label><select id="residents-tenant-type-2" className="s-input" value={editFormData.tenantType || 'Residential'} onChange={e => setEditFormData({...editFormData, tenantType: e.target.value})}><option value="Residential">Residential</option><option value="Commercial">Commercial</option><option value="Section 8">Section 8</option></select></div>
                                <div><label htmlFor="residents-primary-tenant" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Primary Tenant</label><select id="residents-primary-tenant" className="s-input" value={editFormData.primaryTenant || ''} onChange={e => setEditFormData({...editFormData, primaryTenant: e.target.value})}><option value="">—</option><option value="Yes">Yes</option><option value="No">No</option></select></div>
                            </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
                                <div><label htmlFor="residents-birthdate" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Birthdate</label><input id="residents-birthdate" className="s-input" type="date" value={editFormData.birthdate || ''} onChange={e => setEditFormData({...editFormData, birthdate: e.target.value})} /></div>
                                <div><label htmlFor="residents-license-plates" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>License Plates</label><input id="residents-license-plates" className="s-input" value={editFormData.licensePlates || ''} onChange={e => setEditFormData({...editFormData, licensePlates: e.target.value})} /></div>
                            </div>
                            <div style={{ marginBottom: 16 }}>
                                <label htmlFor="residents-pets" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Pets</label>
                                <input id="residents-pets" className="s-input" value={editFormData.pets || ''} onChange={e => setEditFormData({...editFormData, pets: e.target.value})} placeholder="e.g. 1 dog (Labrador), 1 cat" />
                            </div>
                            <div style={{ marginBottom: 16 }}>
                                <label htmlFor="residents-notes" style={{ display: 'block', fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>Notes</label>
                                <textarea id="residents-notes" className="s-input" style={{ minHeight: 50, resize: 'vertical' }} value={editFormData.tenantNotes || ''} onChange={e => setEditFormData({...editFormData, tenantNotes: e.target.value})} />
                            </div>
