...
/**
 * classifyBackendFailure / failureNote / GoogleAccountsFailure moved to
 * ./backendFailure (not Google-specific; plan 060 phase 2) — re-exported here
 * so existing importers keep working.
 */
import type { GoogleAccountsFailure } from './backendFailure';
import { classifyBackendFailure, failureNote } from './backendFailure';
export type { GoogleAccountsFailure } from './backendFailure';
export { classifyBackendFailure, failureNote } from './backendFailure';
