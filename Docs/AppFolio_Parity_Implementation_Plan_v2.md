...
| 2.8 — Sentiment: 3 static handlers + new at-risk fixture + SentimentModule rewire (`isStaticMode` precedent established) | ✓ | `19eb965` | 2026-04-24 | `Docs/Phase2_Task_2_8_Completion_Report.md` (same 8-section template as Task 2.3 / 2.5 / 2.7 / 2.2 / 2.1 / 2.10 / 2.4 / 2.6; backs every ✓ cell with a section reference) |
| 2.9 | pending | — | — | — |
